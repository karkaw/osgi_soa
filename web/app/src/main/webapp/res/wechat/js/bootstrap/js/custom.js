...
$(document).ready(function() {
	...
	// setTimeout(function() {noty({text: '<strong>Howdy! Hope you are doing
	// good...</strong>',layout:'topRight',type:'information',timeout:15000});},
	// 7000);

	// setTimeout(function() {noty({text: 'This is an all in one theme which
	// includes Front End, Admin & E-Commerce. Dont miss it. Grab it
	// now',layout:'topRight',type:'alert',timeout:13000});}, 9000);
